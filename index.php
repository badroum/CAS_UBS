...
if(isset($_POST['username'])&&isset($_POST['password']))
{
    ...
    $url = dirname($_SERVER['SERVER_PROTOCOL']) . "://" . $_SERVER['HTTP_HOST'].$ical . "?username=" . $_POST['username'] ."&password=" .$_POST['password'] . $multipl_result;
                    ...
                    <div id="wrapper">
                        ...
                        <?php
                            ...
                            <form  action="#" autocomplete="on" method="post">
                                <h1>Information</h1>
                                <p>
                                    <label for="username" class="uname info" data-icon="u" > Votre identifiant ubs <span>Rentrez votre identifiant ubs sous la forme e1234567</span> </label>
                                    <input id="username" name="username" required="required" type="text" placeholder="identifiant ubs"/>
                                </p>
                                <p>
                                    <label for="password" class="youpasswd  info" data-icon="p"> Votre mots de passe <span>Rentrez votre mots de passe ubs</span></label>
                                    <input id="password" name="password" required="required" type="password" placeholder="eg. X8df!90EO" />
                                </p>
                                <p class="resource">
									<label for="resources[]" class="youresource info"> Votre / Vos formation <span>Sélectionner votre ou vos formation. C'est un champ à sélection multiple, maintenez Ctrl pour sélectionné plusieurs champs</span></label>
